...
<div class="nav-bar">
    ...
    <div class="nav-item ${param.active == 'statistics' ? 'active' : ''}" onclick="location.href='/admin/lecture_statistics'">강의관리</div>
    <!-- 강의관리, 강의통계, 결제관리 연결 필요 -->
    <div class="nav-item ${param.active == 'statistics' ? 'active' : ''}" onclick="location.href='/admin/lecture_statistics'">강의통계</div>
    <div class="nav-item ${param.active == 'payment' ? 'active' : ''}" onclick="location.href='/admin/payment_management'">결제관리</div>
