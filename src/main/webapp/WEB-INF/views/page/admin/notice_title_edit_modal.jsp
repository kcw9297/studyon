...
<script>
    ...
    // 공지사항 제목 수정 함수 - 모달 열기
    function editNoticeTitle(cardIndex) {
        currentEditingCardIndex = cardIndex;
        const card = document.querySelector(`.notice-card[data-card-idx="\${cardIndex}"]`);
    ...
    async function saveNoticeTitle() {
        ...
        try {
            ...
            const res = await fetch(`/admin/api/notices/\${currentEditingCardIndex}/title`, {
                method: 'PATCH',
                body: formData
            });
            ...
            const card = document.querySelector(`.notice-card[data-card-idx="\${currentEditingCardIndex}"]`);
