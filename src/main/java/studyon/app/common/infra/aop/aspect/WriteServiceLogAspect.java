package studyon.app.common.infra.aop.aspect;
...
import studyon.app.common.dto.LogInfo;
import studyon.app.common.enums.Action;
import studyon.app.common.enums.Entity;
import studyon.app.domain.log.LogDTO;
import studyon.app.domain.log.service.LogService;
...
public class WriteServiceLogAspect {
    ...
    @AfterReturning(
            pointcut =
                    "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoWriteMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoEditMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoInactivateMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoRemoveMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoJoinMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoWithdrawMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoPayMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoRefundMeth() || " +
                            "studyon.app.common.infra.aop.Pointcuts.domainPackSvcAnnoCouponClsIssueMeth()",
            returning = "result"
    )
